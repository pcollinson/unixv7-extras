...
/*
 * ignore some values defined in the superblock
 * but not implemented in UNIXV7. These need to
 * be defined to include the code
 *
 * HAVE_FNAME - superblk.s_fname, superblk.s_fpack
 * HAVE_COUNTS - s_tfree - total free blocks, 	s_tinode - total free inodes
 * CYLS_IN_SUPERBLK = s_m, s_n
 *
 * Peter Collinson
 * August 2023
 */
